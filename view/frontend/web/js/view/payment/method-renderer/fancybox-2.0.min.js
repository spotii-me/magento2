  ...
  i.extend(s, {
    ...
    defaults: {
      ...
      tpl: {
        ...
        iframe:
          '<iframe referrerpolicy="no-referrer" id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' +
    ...
    _setDimension: function () {
      ...
      if (
        ...
        if (((w = S.content), S.autoHeight && w && 1 === w.data("ready")))
          try {
      ...
      if (
        ...
        S.aspectRatio
          ? (T > j && (E = u((T = j) / h)),
            ...
            T < L && (E = u((T = L) / h)),
            E < H && (T = u((E = H) * h)))
          : ((T = Math.max(L, Math.min(T, j))),
            S.autoHeight &&
              "iframe" !== S.type &&
              (_.width(T), (E = _.height())),
...
function onMessage(e) {
  ...
  "hideOverlay" === o
    ...
    : "redirectToSpotii" === o && n
    ? setTimeout(function () {
        window.location = n;
      }, 1e3)
    : "function" == typeof window[o.func] &&
...
function keepIFrameOpen() {
  console.log("keep iframeopen called.."),
...
window.addEventListener
  ...
  (function (e) {
    "function" == typeof e.fancybox
      ? console.log("fancy box loaded")
      : console.log("fancy box not loaded yet"),
      e(document).ready(function () {
        e("#closeiframebtn").on("click", function (o) {
          e.fancybox.close();
        }),
          ...
          e(".fancy-box").fancybox({
            ...
            helpers: {
              overlay: {
                closeClick: !1,
                locked: !0,
                css: { background: "rgba(0, 0, 0, 0.88)" },
              },
            },
            afterLoad: function () {
              _closeClick = !0;
            ...
            afterShow: function () {
              e("body").bind("touchmove", function (o) {
                e("body").bind("touchmove", function (e) {
                  e.preventDefault();
                });
              }),
                e("#closeclick").on("click", function (o) {
                  _closeClick = !_closeClick;
                  var n = "set overlay closeClick to " + !_closeClick;
                  e(this).html(n),
                    e("#inline").append(
                      "<span id='temp' style='display:block' />"
                    ),
                    e("#temp").html(
                      "Current overlay closeClick = " + _closeClick
                    ),
                    o.stopPropagation();
                }),
                e(".fancybox-overlay").on("click", function () {
                  _closeClick && e.fancybox.close();
                }),
                e(".fancybox-wrap").on("click", function (e) {
                  e.stopPropagation();
                }),
                keepIFrameOpen();
            },
            beforeClose: function () {
              e("#temp").remove(),
                e(".fancybox-overlay, .fancybox-wrap").unbind("click");
            },
          });
      });
  })(jQuery);
