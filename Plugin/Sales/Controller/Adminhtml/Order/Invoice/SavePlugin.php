...
namespace Spotii\Spotiipay\Plugin\Sales\Controller\Adminhtml\Order\Invoice;
...
class SavePlugin
{
    ...
    const MERCHANT_SUPPORT_URL = "https://spotii.me/contact-us/merchant-support";
    ...
    */
    ...
    public function aroundExecute(
        ...
        if ($order->getPayment()->getMethodInstance()->getCode() == SpotiiPay::PAYMENT_CODE) {
    ...
    private function handleCaptureAction($invoice)
    {
        ...
        $reference = $this->order->getPayment()->getAdditionalInformation(SpotiiPay::ADDITIONAL_INFORMATION_KEY_ORDERID);
        ...
        if (isset($spotiiOrderInfo['total'])
            ...
            $hasSpotiiCaptured = $this->spotiiPay
                                        ->spotiiCapture($reference);
            if ($hasSpotiiCaptured) {
